        ...
        <div style="background-color:#F2F2F2" >
            <div style="line-height:50px;position: sticky;top: 0px; display: flex;height: 50px;background-color: rgb(253,253,253);z-index:99" >
                <div class="logo" style="text-align: center">
                    <img src="../../assets/FrontLogo1.png" style="margin-top: 10px;width: 98px;height: 32px">
                </div>
                <div class="nav">
                    <ul style="list-style: none">
                        <li><a href="/front/home">首页</a> </li>
                        <li><a href="/front/article">文章</a> </li>
                        <li><a href="/front/resourceDownload">资源下载</a> </li>
                        <li><a href="/front/category">专题</a> </li>
<!--                        <li><a href="/front/im">聊天室</a> </li>-->

                    </ul>
                </div>
                <div class="search"  >
<!--                    <el-input-->
<!--                            style="height: 30px;border-bottom-right-radius: 0px"-->
<!--                            placeholder="请输入关键词"-->
<!--                            v-model="input"-->
<!--                            clearable>-->
<!--                    </el-input>-->
<!--                    <el-button style="display: flex;height:30px;margin-top: 10px" type="primary" icon="el-icon-search">搜索</el-button>-->
                </div>
                <div class="user">
                    <div v-if="!user.username">
                        <el-button type="primary" style="background-color: #FC427B;border: none;margin-right: 10px; margin-top:10px;height: 30px" @click="$router.push('/front/login')">登录</el-button>
                        <el-button type="primary" style="background-color: #FC427B;border: none;height: 30px;margin-top:10px;" @click="$router.push('/front/register')">注册</el-button>
                    </div>
                    <div v-if="user.username">
                        ...
                        <div style="display: flex;margin-right: 60px">
                            <el-dropdown>
                                <el-button  type="primary" style="background-color: #ff4757;border: none;height: 30px" round>
                                ...
                                <el-dropdown-menu slot="dropdown" style="width: 160px;height: 80px;">
                                    ...
                                    <div style="float: left;height: 100%;width: 50%;text-align: center;border-right: #cccccc 2px solid;cursor: pointer" @click="articleRelease">
                                        <div style="height: 40px;width: 40px; margin-left: 20px;margin-top: 10px;text-align: center">
                                            <img src="../../assets/publish.png" style="margin: 0px auto;width: 30px;height: 30px">
                                        </div>
                                        <div>
                                            <span style="color: #ff4757;font-size: 10px;text-align: center" >发布文章</span>
                                        </div>
                                    </div>
                                    <!--                           resourceUpload-->
                                    ...
                                    <li style="display: block; float: left;height: 100%;width: 50%;text-align: center;cursor: pointer;cursor: pointer">
                                        <a href="/front/frontResourceUpload" style="text-decoration: none">
                                            <div style="height: 40px;width: 40px; margin-left: 20px;margin-top: 10px;text-align: center;">
                                                <img src="../../assets/uploadUser1.png" style="margin: 0px auto;width: 30px;height: 30px">
                                            </div>
                                            <div>
                                                <span style="color: #ff4757;font-size: 10px;text-align: center" >上传资源</span>
                                            </div>
                                        </a>
                                    </li>
