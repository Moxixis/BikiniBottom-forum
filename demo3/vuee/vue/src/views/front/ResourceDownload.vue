            ...
            <div class="leftSide">
                <div class="recommandResources" v-for="item in tableData">
                    ...
                    <div style="flex: 2;display: flex;flex-direction: column">
                        ...
                        <div style="flex: 3;color: #999aaa ;font-size: 14px">
<!--                            <span style="margin-right: 10px; "> <i class="el-icon-user"></i> {{item.username}}</span>-->
                            <sapn style=""> <i class="el-icon-timer"></i> {{item.time}}</sapn>
                        </div>
