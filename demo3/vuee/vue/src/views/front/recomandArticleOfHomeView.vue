<template>
    <div style="width: 100%;height:450px;background-color: #FAFAFA">
      <div style="display: flex;flex-direction: column;justify-items: center;width: 100%;height: 100%">
          <div class="aaaa" v-for="item in recommandArticle" @click="$router.push('/front/articleDetail?id='+item.id)" style="display: flex;flex: 1; flex-direction: column;padding: 10px 30px ;cursor: pointer" >
<!--            文章标题-->
              <div style="flex: 1;color: #222226;font-size: 18px;font-weight: 600; " >
                  <span>
                      {{item.name}}
                  </span>
              </div>
