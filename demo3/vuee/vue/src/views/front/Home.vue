    ...
    <div style="margin: auto 50px;height: 1000px; z-index: 2; background-color: #FAFAFA">
        ...
        <div style="width: 70%;height: 100%;float: left; background-color:#FAFAFA">
            ...
            <div style="height: 45%;width: 100%;background-color:#FAFAFA;margin-top: 10px">
                ...
                <div class="newArticle" style="width: 28%;height: 100%;float: left;background-color:#FAFAFA;margin-left: 19.8px">
                    ...
                    <div class="article_1" style="margin-top: 5px;height: 400px;width: 100%;">
                            <div  class="theTitleOfArticle" v-for="item in tableData" :key="item.id"  @click="$router.push('/front/articleDetail?id='+item.id)">
                                <div class="article-head" style=" cursor: pointer;margin:0px 5px ;line-height: 22px;height: 22px;text-overflow: ellipsis;
overflow: hidden;color: #000; font-weight: normal"  >{{item.name}}</div>
                ...
                <div class="newASource" style="width: 28%;height: 100%;float: left;background-color:#FAFAFA;margin-left: 19.8px">
                    <div class="title_2" style="height: 30px;width: 100%;margin-top: 10px;background-color: #FAFAFA">
                    ...
                    <div class="resource_1" style="margin-top: 5px;height: 400px;width: 100%;">
                        <div  class="theTitleOfResource" v-for="item in resourcesTableData" :key="item.id">
                            <div class="article-head" style=" cursor: pointer;margin:0px 5px ;line-height: 22px;height: 22px;text-overflow: ellipsis;
overflow: hidden;color: #000; font-weight: normal"   @click="download(item.url,item.id)">{{item.name}}
                            </div>
                            <div style="height: 60px;overflow: hidden ;text-overflow:ellipsis;color: #999999;word-break: break-all;font-size: 14px;padding-left: 5px">
                                {{item.brief}}
                            </div>
            ...
            <div style="height: 51%;width: 100%;background-color: rgb(245,246,247);margin-top: 10px;margin-bottom: 30px">
              <div class="about">
                  <el-menu
                      ...
                      <el-menu-item index="/front/home/recomandResourceOfHomeView">推荐资源</el-menu-item>
                  </el-menu>
              </div>
        ...
        <div style="width: 29%;height: 100%;float:right;background-color: #FAFAFA;margin-bottom: 10px">
            <div class="rili" style="background-color: #ff4757">
                <el-calendar v-model="value" style="background-color: #FBFBFB">
            ...
            <a  class="guanggao" href="https://bbs.csdn.net" target="_blank">
...
.img_resource{
    ...
    width: 20px;
    height: 20px;
    background-image: url("../../assets/resource1.png");
    background-size: 100%;
}
.newASource span{
    float: right;
...
.guanggao{
    ...
    width: 100%;
    height:45%;
    background-image: url("../../assets/guanggaoOfHome1.jpeg");
    background-size: 100%;
...
.rili /deep/  .el-calendar-table .is-selected{
...
/deep/ .el-calendar__button-group :hover {
  color: rgba(255, 71, 87,1.0);
