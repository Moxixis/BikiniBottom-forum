    ...
    <div style="position: sticky;top:0px;z-index: 999">
        <div style="height: 60px;background-color: rgb(251,251,251);">
            ...
            <div class="title">
                ...
                <input v-model="article.name" type="text" placeholder="请输入标题" ></input>
            </div>
            <div class="release">
...
<!--                      slot="reference"-->
                    ...
                    <el-button class="fabu" type="primary" style="width: 100px;height: 40px;border-radius: 23px;font-size: 14px;margin-left: 10px"  @click="handleEdit"><i class="el-icon-position" ></i> 发布文章</el-button>
    ...
    <div style="width: 100%;height: 100%;">
            ...
            <mavon-editor ref="md" style="height: 100%;width: 100%" v-model="article.content" :ishljs="true" :navigation="true" :subfield="true":scrollStyle="true" toolbarsBackground="#FF9C9B" @imgAdd="imgAdd"/>
        ...
        <el-dialog title="文章信息" :visible.sync="dialogFormVisible" width="30%" fullscreen="true">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button style="width: 70px;height: 40px "  type="primary"  class="fabu" @click="handleSave">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
        ...
        methods:{
            ...
            imgAdd(pos, $file) {
                ...
                axios({
                    ...
                    method: 'post',
                    data: formData,
                    headers: {'Content-Type': 'multipart/form-data'}, //enctype的值是application/x-www-form-urlencoded，不能用于文件上传，只有使用了multipart/form-data，才能完整的传递文件数据
                }).then((res) => {
